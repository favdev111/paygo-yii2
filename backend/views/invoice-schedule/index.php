 ...
 * @var common\models\search\InvoiceSchedule $searchModel
 */

$this->title = Yii::t('app', 'Invoice Schedules');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="invoice-schedule-index">
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['invoice-schedule/view', 'id' => $model->id, 'edit' => 't']),

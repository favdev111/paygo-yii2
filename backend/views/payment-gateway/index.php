 ...
 * @var common\models\search\PaymentGateway $searchModel
 */

$this->title = Yii::t('app', 'Payment Gateways');
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['payment-gateway/view', 'id' => $model->id, 'edit' => 't']),

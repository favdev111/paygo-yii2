 ...
 * @var common\models\search\AccountRelation $searchModel
 */

$this->title = Yii::t('app', 'Account Relations');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="account-relation-index">
    ...
    <?php Pjax::begin(); echo GridView::widget([
        ...
        'columns' => [
            ...
            'id',
            'payee_account_id',
            'payee_account_relation_type_id',
            'payor_account_id',
            'payor_account_relation_type_id',
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['account-relation/view', 'id' => $model->id, 'edit' => 't']),

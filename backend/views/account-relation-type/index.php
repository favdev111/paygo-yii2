 ...
 * @var common\models\search\AccountRelationType $searchModel
 */

$this->title = Yii::t('app', 'Account Relation Types');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="account-relation-type-index">
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['account-relation-type/view', 'id' => $model->id, 'edit' => 't']),

 ...
 * @var common\models\search\InvoiceDetail $searchModel
 */
...
//            'tax_amount', 
//            'discount_type', 
//            ['attribute' => 'discount_amount','format' => ['datetime',(isset(Yii::$app->modules['datecontrol']['displaySettings']['datetime'])) ? Yii::$app->modules['datecontrol']['displaySettings']['datetime'] : 'd-m-Y H:i:s A']], 
//            'subtotal', 
//            'invoice_id', 
                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['invoice-detail/view', 'id' => $model->id, 'edit' => 't']),
